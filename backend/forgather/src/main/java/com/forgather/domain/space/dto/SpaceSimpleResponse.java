...
public record SpaceSimpleResponse(
    ...
    public static SpaceSimpleResponse from(Space space, SpacePhotoResponse spacePhoto, Long guestBookCardCount) {
        return new SpaceSimpleResponse(
            space.getId(),
            space.getCode(),
            space.getName(),
