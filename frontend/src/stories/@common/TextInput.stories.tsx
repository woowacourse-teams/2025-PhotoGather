...
export const Default: Story = {
  render: (args) => {
    ...
    return (
      <TextInput
        {...args}
        validLength={calculateValidLength(value)}
...
export const ShowError: Story = {
  args: {
    ...
    value: '잘못된 값',
    validLength: calculateValidLength('잘못된 값'),
  },
};
...
export const FiveCharacters: Story = {
  args: {
    value: '12345',
    validLength: calculateValidLength('12345'),
  },
};
...
export const OverMaxLength: Story = {
  args: {
    ...
    validLength: calculateValidLength('12345678901'),
  },
};
